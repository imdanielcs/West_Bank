 ...
 * @author imdan
 */
public class VentanaGirar extends javax.swing.JFrame {
    ...
    public VentanaGirar(ArrayList<Cliente> clientes) {
        initComponents();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(txtRutBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jLabel3)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(txtDv, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
//        }   else {
//        JOptionPane.showMessageDialog(this, "El rut no ha sido encontrado.", "Cliente no encontrado", JOptionPane.ERROR_MESSAGE);
//        }
        String rut = txtRutBuscar.getText();
...
//    public int girar (int monto, int saldo) {
...
//            JOptionPane.showMessageDialog(this, "Monto supera al saldo actual.", "Saldo insuficiente", JOptionPane.ERROR_MESSAGE);
//        }
//        return saldo;
//    }
...
//                int nuevoSaldo = girar(monto, saldoActual);
//                clienteEncontrado.getCuenta().setSaldo(nuevoSaldo);
//                
//                JOptionPane.showMessageDialog(this, "Giro realizado con éxito. Nuevo saldo: " + nuevoSaldo + " pesos", "Giro", JOptionPane.INFORMATION_MESSAGE);
//            } else {
//                JOptionPane.showMessageDialog(this, "Monto supera al saldo actual.", "Saldo insuficiente", JOptionPane.ERROR_MESSAGE);
//            }
//        } catch (NumberFormatException e) {
//            JOptionPane.showMessageDialog(this, "Error: Ingresa un número entero válido", "Error", JOptionPane.ERROR_MESSAGE);
//        }
//    }
    String rut = txtRutBuscar.getText();
    String montoTexto = txtMonto.getText();
                ...
                if (resultSetSaldo.next()) {
                    ...
                    if (saldoActual >= monto) {
                        ...
                        try (PreparedStatement preparedStatementActualizarSaldo = conexion.prepareStatement(consultaActualizarSaldo)) {
                            ...
                            // Ejecutar la consulta para actualizar el saldo
                            ...
                            if (filasAfectadas > 0) {
                                ...
                                JOptionPane.showMessageDialog(this, "No se pudo realizar el retiro. Cliente no encontrado.", "Error", JOptionPane.ERROR_MESSAGE);
                            }
                        }
                    } else {
    ...
    private void btnRegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegresarActionPerformed
         this.dispose();
        VentanaGirar.this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaGirar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaGirar().setVisible(true);
            }
        });
    }
